% Run after onlyStatsTopDownNew
labels={'Control','    4Hz','    8Hz','   15Hz','   25Hz','   40Hz','   80Hz','  Tonic'};
h(1)=figure(36);
clf
boxplot([peaksb1RScontrol peaksb1RS],'PlotStyle','compact','Labels',{'','','','','','','',''},'Colors',[0 0 0],'jitter',0.1)
hold on
boxplot([peaksb1IBcontrol peaksb1IB],'PlotStyle','compact','Labels',{'','','','','','','',''},'Colors',[0 0 1],'jitter',0.1,'Positions',(1.2:1:8.2))
...
fullFilepathTemp={strcat(folder,'/topDown-bplots-b1'),strcat(folder,'/topDown-bplots-b2')};
...
print(h(1),strcat(folder,'/topDown-bplots-b1'),'-dpdf','-r0')
print(h(2),strcat(folder,'/topDown-bplots-b2'),'-dpdf','-r0')
