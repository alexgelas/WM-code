...
load(strcat(folder,'/tenColumns/tenColumns.mat'))
latePowerRSnoInput=latePowerRS;
latePowerIBnoInput=latePowerIB;
...
pRS=powerPeakTest(latePowerRSnoInput,latePowerRS15Hz,minBeta1index,maxBeta1index)
pIB=powerPeakTest(latePowerIBnoInput,latePowerIB15Hz,minBeta1index,maxBeta1index)

load(strcat(folder,'/topDown-25Hz/topDown-25Hz.mat'))
latePowerRS25Hz=latePowerRS;
latePowerIB25Hz=latePowerIB;
pRS=powerPeakTest(latePowerRSnoInput,latePowerRS25Hz,minBeta1index,maxBeta1index)
pIB=powerPeakTest(latePowerIBnoInput,latePowerIB25Hz,minBeta1index,maxBeta1index)

load(strcat(folder,'/topDown-40Hz/topDown-40Hz.mat'))
latePowerRS40Hz=latePowerRS;
latePowerIB40Hz=latePowerIB;
%pRS=powerPeakTest(earlyPowerRS,latePowerRS,minBeta1index,maxBeta1index)
%pIB=powerPeakTest(earlyPowerIB,latePowerIB,minBeta1index,maxBeta1index)
pRS=powerPeakTest(latePowerRSnoInput,latePowerRS40Hz,minBeta1index,maxBeta1index)
pIB=powerPeakTest(latePowerIBnoInput,latePowerIB40Hz,minBeta1index,maxBeta1index)
